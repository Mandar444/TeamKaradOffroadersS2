                   ...
                   <div className="grid grid-cols-1 gap-12 relative z-10">
                      ...
                      <div className="pt-8 border-t border-white/10 flex items-center justify-between gap-10">
                         <div className="flex items-center gap-8">
                            <div className="bg-primary/10 border border-primary/20 p-4 rounded-xl shrink-0 flex items-center justify-center">
                            ...
                            <div>
                               ...
                               <a 
                                 href={`https://wa.me/918087977674?text=${encodeURIComponent(`Hi TKO, I am viewing the Grid Pass for Team: ${selectedTeam.team_name} (#${selectedTeam.car_number}).`)}`}
                                 target="_blank" 
                                 className="text-[8px] text-zinc-500 hover:text-primary transition-colors font-mono mt-3 uppercase tracking-tighter block"
                                >
                                  TAP TO CONTACT RACE CONTROL OFFICE
                                </a>
                            </div>
                         </div>
                ...
                <div className="px-8 pb-10 space-y-8 relative z-10">
                   ...
                   <div className="flex flex-col items-center gap-6">
                      ...
                      <div className="text-center">
                         <p className="text-zinc-500 text-[10px] font-black uppercase tracking-[0.4em] mb-2 leading-none italic">GRID STATUS: ACTIVE</p>
                         <a 
                            href={`https://wa.me/918087977674?text=${encodeURIComponent(`Hi TKO, I am viewing the Mobile Grid Pass for Team: ${selectedTeam.team_name} (#${selectedTeam.car_number}).`)}`}
                            target="_blank" 
                            className="bg-primary/10 px-4 py-2 rounded-lg text-primary font-bold text-[8px] uppercase tracking-widest block mt-4"
                          >
