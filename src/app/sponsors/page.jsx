...
export default function SponsorsPage() {
  return (
    <div className="min-h-[90vh] bg-black text-white pt-28 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6 relative overflow-hidden flex flex-col items-center justify-center">
      {/* Background Decor */}
      ...
      <div className="max-w-4xl mx-auto relative z-10 w-full text-center">
        ...
        <motion.div
            ...
            className="inline-flex max-w-full items-center gap-3 px-4 sm:px-6 py-2 rounded-full bg-zinc-900 border border-white/10 text-[10px] font-black uppercase tracking-[0.16em] sm:tracking-[0.5em] mb-8"
        >
        ...
        <motion.h1 
            ...
            className="text-5xl sm:text-6xl md:text-8xl font-heading text-white tracking-normal uppercase leading-none mb-8"
        >
        ...
        <motion.p 
            ...
            className="text-base sm:text-lg md:text-2xl text-zinc-400 max-w-2xl mx-auto font-sans leading-relaxed mb-12 md:mb-16"
        >
        ...
        <motion.div 
          ...
          className="relative rounded-[2rem] sm:rounded-[3rem] overflow-hidden group max-w-3xl mx-auto"
        >
          <div className="absolute inset-0 bg-gradient-to-b from-primary/10 to-transparent border border-white/5 rounded-[2rem] sm:rounded-[3rem]" />
